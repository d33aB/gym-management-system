...
app_publisher = "Andreea Burcescu"
app_description = "System for tracking gym memberships. Handles memberships, member types, locker allocation, group classes, professional trainer subscriptions etc."
app_email = "info@gym.com"
app_license = "MIT"
